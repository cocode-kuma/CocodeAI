...
import { handleCocodeAIOAuthCallback } from './api/cocodeai-oauth.js'
import { handleCocodeAIOpenAIOAuthCallback } from './api/cocodeai-openai-oauth.js'
    ...
    server = Bun.serve<WebSocketData>({
      ...
      async fetch(req, server) {
        ...
        if (
          ...
          return handleCocodeAIOpenAIOAuthCallback(url)
        }
