...
const originalDisableTerminalShellEnv = process.env.COCODEAI_DISABLE_TERMINAL_SHELL_ENV
...
function restoreEnv(): void {
  ...
  if (originalDisableTerminalShellEnv) {
    process.env.COCODEAI_DISABLE_TERMINAL_SHELL_ENV = originalDisableTerminalShellEnv
  } else {
...
describe('cron scheduler launcher resolution', () => {
  ...
  it('prefers an explicit COCODEAI_ROOT when it points at a source checkout', async () => {
