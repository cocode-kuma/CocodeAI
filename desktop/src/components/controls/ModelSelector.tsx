...
export function ModelSelector({
  ...
  const claudeOAuthStatus = useCocodeAIOAuthStore((s) => s.status)
  const fetchClaudeOAuthStatus = useCocodeAIOAuthStore((s) => s.fetchStatus)
  const openAIOAuthStatus = useCocodeAIOpenAIOAuthStore((s) => s.status)
  const fetchOpenAIOAuthStatus = useCocodeAIOpenAIOAuthStore((s) => s.fetchStatus)
