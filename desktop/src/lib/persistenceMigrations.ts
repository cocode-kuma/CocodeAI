...
export const DESKTOP_PERSISTENCE_VERSION_KEY = 'cocodeai.persistence.schemaVersion'
...
const TAB_STORAGE_KEY = 'cocodeai-open-tabs'
const SESSION_RUNTIME_STORAGE_KEY = 'cocodeai-session-runtime'
const THEME_STORAGE_KEY = 'cocodeai-theme'
