...
export const zh: Record<TranslationKey, string> = {
  ...
  'settings.terminal.description': '直接运行宿主机命令，用于安装插件、Skills、MCP 等扩展。桌面端已内置 CocodeAI；文档里的 claude <参数> 可替换成 cocodeai <参数>，例如 cocodeai plugin install ... 或 cocodeai mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '只会清理：cocodeai-open-tabs、cocodeai-session-runtime、cocodeai-theme、cocodeai-locale 和 cocodeai.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/cocodeai/settings.json — 直接编辑，保存时写入。',
  ...
  'settings.general.storagePortableDirPlaceholder': '选择一个用于保存 CocodeAI 数据的文件夹',
  ...
  'settings.general.storageMoveHint': '切换目录不会自动搬迁旧数据。如果希望旧会话继续出现，请把原目录下的 projects、skills、plugins、cocodeai 等数据复制到新目录。要做便携包，建议把目录放在应用旁边并一起压缩。',
  ...
  'settings.general.notificationsTestTitle': 'CocodeAI 通知已启用',
  ...
  'settings.general.syncHistoryTitle': '会话记录同步',
  'browser.openInWorkspace': '在工作台打开',
  'browser.openExternal': '外部打开',
  'browser.refresh': '刷新预览',
  'browser.screenshotFull': '截全页',
  'browser.screenshotLabel': '页面截图',
  'browser.elementScreenshotLabel': '选中元素截图',
  'browser.inspectorToggle': '框选元素',
  'browser.inspectorLocalOnly': '仅本地页面支持框选',
  'browser.emptyHint': '输入 localhost 地址或本地文件路径',
  'browser.descPlaceholder': '描述修改需求，回车发送…',
  'browser.send': '发送',
  'browser.sending': '发送中...',
  'browser.selectParent': '选择父级',
  'browser.dismissSelection': '关闭选中元素',
  'browser.invalidTarget': '请输入 localhost 地址或 HTML 文件路径。',
  'browser.elementPromptHeader': '请修改以下元素：',
  'workspace.browser': '浏览器',
  'settings.general.syncHistoryDescription': '控制是否将对话记录保存到本地 ~/.claude/projects/ 目录（JSONL 格式）。',
  'settings.general.syncHistoryEnabled': '同步 Claude Code 会话记录',
  'settings.general.syncHistoryHint': '关闭后，新会话不再写入本地文件，也不会出现在 Claude Code CLI 的历史记录中。',
