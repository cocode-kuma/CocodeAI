export const en = {
  ...
  'settings.terminal.description': 'Run host-machine commands for plugin, skill, and MCP setup. The desktop app includes cocodeAI; replace documented claude <args> with cocodeai <args>, for example: cocodeai plugin install ... or cocodeai mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Clears only: cocodeai-open-tabs, cocodeai-session-runtime, cocodeai-theme, cocodeai-locale, and cocodeai.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/cocodeai/settings.json — edit directly, will be written on save.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for cocodeAI data',
  ...
  'settings.general.storageMoveHint': 'Switching directories does not migrate existing data. Copy projects, skills, plugins, cocodeai, and related folders from the old directory if you want old sessions to keep appearing. For a portable bundle, keep this folder beside the app and zip them together.',
  ...
  'settings.general.notificationsTestTitle': 'cocodeAI notifications are enabled',
  ...
  'settings.general.syncHistoryTitle': 'Session History Sync',
  'browser.openInWorkspace': 'Open in Workspace',
  'browser.openExternal': 'Open Externally',
  'browser.refresh': 'Refresh preview',
  'browser.screenshotFull': 'Screenshot page',
  'browser.screenshotLabel': 'Page screenshot',
  'browser.elementScreenshotLabel': 'Selected element screenshot',
  'browser.inspectorToggle': 'Pick element',
  'browser.inspectorLocalOnly': 'Element picker only works on local pages',
  'browser.emptyHint': 'Enter a localhost URL or local file path',
  'browser.descPlaceholder': 'Describe the change, press Enter to send…',
  'browser.send': 'Send',
  'browser.sending': 'Sending...',
  'browser.selectParent': 'Select parent',
  'browser.dismissSelection': 'Dismiss selected element',
  'browser.invalidTarget': 'Enter a localhost URL or an HTML file path.',
  'browser.elementPromptHeader': 'Please modify the following element:',
  'workspace.browser': 'Browser',
  'settings.general.syncHistoryDescription': 'Controls whether conversations are saved to ~/.claude/projects/ locally (JSONL format).',
  'settings.general.syncHistoryEnabled': 'Sync Claude Code session history',
  'settings.general.syncHistoryHint': 'When disabled, new sessions are not written to local files and will not appear in Claude Code CLI history.',
