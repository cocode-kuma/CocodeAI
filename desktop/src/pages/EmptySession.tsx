...
export function EmptySession() {
  ...
  return (
    <div className="empty-session-page relative flex flex-1 flex-col overflow-hidden">
      {/* 背景装饰光晕 */}
      {!isMobileComposer && (
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute left-1/2 top-[42%] h-[520px] w-[520px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[var(--color-brand)] opacity-[0.06] blur-[120px]" />
        </div>
      )}

      <div className={`flex flex-1 flex-col items-center justify-center ${
        isMobileComposer ? 'px-6 pb-[18vh] pt-8' : 'px-8 pb-[20vh] pt-8'
      }`}>
        {/* 欢迎文字 */}
        ...
        <div
          ...
          className={`flex w-full justify-center ${isMobileComposer ? 'px-3' : 'px-0'}`}
        >
