...
All diagrams use a dark background (#1a1a2e) with CocodeAI orange-blue accent (#FF7A00), consistent with Claude Code's official documentation style.
...
- [Agent Tool Source Code](https://github.com/NanmiCoder/cocodeai/tree/main/src/tools/AgentTool/)
- [Swarm Infrastructure](https://github.com/NanmiCoder/cocodeai/tree/main/src/utils/swarm/)
- [Task Management System](https://github.com/NanmiCoder/cocodeai/tree/main/src/tasks/)
