...
export default withMermaid(defineConfig({
  ...
  locales: {
    ...
    en: {
      ...
      themeConfig: {
        editLink: {
          pattern: 'https://github.com/NanmiCoder/cocodeai/edit/main/docs/:path',
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/NanmiCoder/cocodeai' },
    ],
    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright 2026 CocodeAI Contributors',
    },
  },
}))
