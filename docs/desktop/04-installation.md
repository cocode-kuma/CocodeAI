...
前往 [GitHub Releases](https://github.com/NanmiCoder/cocodeai/releases) 下载对应平台的安装包：

| 平台 | 文件 |
|------|------|
| macOS (Apple Silicon) | `Claude.Code.CocodeAI_x.x.x_aarch64.dmg` |
| macOS (Intel) | `Claude.Code.CocodeAI_x.x.x_x64.dmg` |
| Windows (x64) | `Claude.Code.CocodeAI_x.x.x_x64-setup.exe` |
...
```bash
xattr -cr /Applications/Claude\ Code\ CocodeAI.app
```
